...
\begin{document}
\name{Lonnie Gerol}
\tagline{Seeking a co-op or internship as a Software Engineer, available starting the Summer of 2023.}
...
% Bryx
\cvevent{iOS Engineer}{Bryx}{December 2022 - Present}{Rochester, NY}
\appstore{https://apple.co/3RBf3ip}{}
\begin{itemize}
...
% Apple
\cvevent{Software Engineer}{Apple}{May 2021 -- August 2021}{Remote}
\begin{itemize}
...
\end{itemize}
\cvtag{Swift | Objective-C}

\divider

% Macro
\cvevent{Software Engineer}{Macro}{January 2021 - May 2021}{Remote}
\begin{itemize}
